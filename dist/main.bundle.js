...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.submitLogin = function () {
        this.dataService.postSignIn(this.signin).subscribe(function (data) { }, function (err) { console.log(err); }, function () { return console.log('Request Completed'); });
        this.status = true;
    };
